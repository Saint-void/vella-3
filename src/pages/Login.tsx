  ...
  return (
    <main className="w-full min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-vella-black overflow-hidden relative">
      ...
      <div className="flex flex-col px-8 sm:px-16 lg:px-24 py-12 relative z-10 min-h-screen border-r border-white/5 bg-vella-black/80 backdrop-blur-xl">
        ...
        >
          <h1 className="text-3xl md:text-4xl font-bold text-white tracking-tight mb-2">Login to Your Account</h1>
          <p className="text-vella-accent/60 text-sm md:text-base mb-10">Welcome back to Vella</p>

          <div className="grid grid-cols-2 gap-4 mb-8">
            <button className="flex items-center justify-center gap-2 py-3 border border-white/10 rounded-xl hover:bg-white/5 transition-colors text-sm font-medium text-white/80"
             type="button"
              onClick={async () => {
          ...
          <form className="space-y-4" onSubmit={handleLogin}>
            ...
            <div className="flex items-center justify-between pt-2 pb-4">
              <label className="flex items-center gap-2 cursor-pointer group">
                <div className={`w-5 h-5 rounded-md border flex items-center justify-center transition-colors ${rememberMe ? 'bg-white border-white text-vella-black' : 'border-white/20 group-hover:border-white/40'}`}>
                  {rememberMe && <Check size={14} className="text-vella-black" />}
                </div>
                <input 
                  type="checkbox" 
                  className="hidden" 
              ...
              <a href="#" className="text-sm text-white/70 hover:text-white transition-colors">Forgot Password?</a>
            </div>

            <button className="w-full py-4 bg-white text-vella-black rounded-xl text-sm font-semibold hover:bg-gray-200 transition-colors flex items-center justify-center">
      ...
      <div className="hidden lg:flex relative items-center justify-center overflow-hidden z-10 bg-vella-black/40 backdrop-blur-sm">
        <div className="absolute top-8 right-8 flex gap-6 text-sm text-white/70">
          ...
          <Link to="/signup" className="px-4 py-1.5 bg-white rounded-md text-vella-black font-medium hover:bg-gray-200 transition-colors">Get Started</Link>
        </div>
